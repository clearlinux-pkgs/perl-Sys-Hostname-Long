...
Requires: perl-Sys-Hostname-Long-man
...
%package man
Summary: man components for the perl-Sys-Hostname-Long package.
Group: Default

%description man
man components for the perl-Sys-Hostname-Long package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Sys/Hostname/Long.pm
/usr/lib/perl5/site_perl/5.26.1/Sys/Hostname/testall.pl
